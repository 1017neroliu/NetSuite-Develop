//yaffil.wu@tctchina.com.cn  180905，Nero借鉴Yaffil脚本
...
function aftersubmitfeiyong(type) {
	...
	if (type == 'create' || type == 'edit') {
		//分摊
		var fentancheck = [ 'custbody_invoice_yfsfft',
		...
		//费用主体字段
			feiyongbody = [
				'custbody_invoice_yjyf', 'custbody_invoice_yjxbf',
				'custbody_invoice_yjybf', 'custbody_invoice_yjbgf',
				'custbody_invoice_yjyj', 'custbody_est_yfybje',
				'custbody_est_xbfybje', 'custbody_est_ybfybje',
				'custbody_est_bgfybje', 'custbody_est_yjybje' ], 
		//货币类型
			currencytype = [
		...
		//费用列字段
			feiyongcolumn = [
				'custcol_sales_invoice_ygyf', 'custcol_sales_invoice_yjxbf',
				'custcol_sales_invoice_yjybf', 'custcol_sales_invoice_yjbgf',
				'custcol_sales_invoice_yjyj','custcol_est_freight_real_currency',
				'custcol_est_credit_real_currency','custcol_est_yunbao_real_currency',
				'custcol_est_baogan_real_currency','custcol_est_yongji_real_currency' ];
		//加载SO
